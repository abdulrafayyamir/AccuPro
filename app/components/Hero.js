  ...
  return (
    <section className="hero mt-5  py-20 lg:py-24 flex flex-col-reverse lg:flex-row items-center">
      <div className="container mx-auto px-4 lg:w-1/2 text-center lg:text-left">
        <h1 className="text-2xl lg:text-2xl font-bold text-[#] mb-4 capitalize">We simplify numbers, fuel your passion, and boost your profits so that you can run your business with confidence. </h1>
