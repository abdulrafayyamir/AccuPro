  ...
  return (
    <footer className="bg-gray-100 py-6">
      ...
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center justify-between">
        ...
        <p className="text-center md:text-left text-gray-800 text-xl font-bold mb-4 md:mb-0 ml-[69px] md: ml-[27px]">AccuPro Bookkeeping LLC</p>
        
        <div className="flex items-center space-x-4">
          <img src="/images/accuprologo.jpg" alt="AccuPro Bookkeeping LLC Logo" className="w-16 md:w-20" />
          <img src="/images/quickbooks.png" alt="QuickBooks Certified ProAdvisor" className="w-16 md:w-20" />
          <img src="/images/qbonline.png" alt="QuickBooks Certified ProAdvisor" className="w-[10] md:w-20" />
          <img src="/images/quickbooksadvanced.png" alt="QuickBooks Certified ProAdvisor" className="w-20 md:w-20" />
        </div>
      </div>

      

      {/* Include the KeepInTouchSection component here */}
